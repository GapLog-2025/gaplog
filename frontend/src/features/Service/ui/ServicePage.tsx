    ...
    <div className="max-w-6xl mx-auto py-12 px-4">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          갭로그는 공백기, 낮은 학점, 비전공, 경력 단절 등으로 인해 취업과
          커리어 설계에 심리적 위축을 겪는 청년들에게 회복과 도전의 실마리를
          제공하는 공감 기반 커리어 콘텐츠 플랫폼입니다.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-8 hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              비슷한 경험을 가진 선배들의 극복 사례와 취업 성공 스토리를 통해
              용기와 인사이트를 얻을 수 있습니다.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-lg p-8 hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              개인의 상황과 목표에 맞는 취업 준비 로드맵을 제공하여 체계적인
              커리어 준비를 도와드립니다.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg p-8 hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              취업 준비 과정에서 겪는 심리적 어려움을 관리하고 정서적 회복을
              돕는 콘텐츠와 도구를 제공합니다.
            </p>
          </div>
        </div>
      ...
      <div className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold mb-2">공감과 연결</h3>
              <p className="text-gray-600">
                비슷한 경험을 가진 사람들이 서로의 이야기를 공유하고 공감하며
                연결될 수 있는 커뮤니티를 만듭니다.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold mb-2">실질적인 도움</h3>
              <p className="text-gray-600">
                단순한 위로를 넘어 실제 취업에 도움이 되는 구체적인 정보와 실천
                가능한 조언을 제공합니다.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold mb-2">다양성 존중</h3>
              <p className="text-gray-600">
                각자의 배경과 상황이 다름을 인정하고, 다양한 경로와 방식의 성공
                사례를 보여줍니다.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold mb-2">심리적 회복</h3>
              <p className="text-gray-600">
                취업 준비 과정에서 흔들릴 수 있는 자존감과 정신 건강을 회복하고
                유지할 수 있도록 돕습니다.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-16 md:space-y-0">
            <div className="md:flex items-center">
              <div className="md:w-1/2 md:pr-12 mb-6 md:mb-0 md:text-right">
                ...
                <p className="text-gray-600">
                  간단한 회원가입 후 나의 상황과 목표에 맞는 프로필을 설정하여
                  맞춤형 콘텐츠를 받아보세요.
                </p>
              </div>
            ...
            <div className="md:flex items-center flex-row-reverse">
              <div className="md:w-1/2 md:pl-12 mb-6 md:mb-0">
                ...
                <h3 className="text-xl font-bold mb-2">공백기 후기 탐색</h3>
                <p className="text-gray-600">
                  비슷한 경험을 가진 선배들의 극복 사례와 취업 성공 스토리를
                  탐색하고 인사이트를 얻으세요.
                </p>
              </div>
            ...
            <div className="md:flex items-center">
              <div className="md:w-1/2 md:pr-12 mb-6 md:mb-0 md:text-right">
                ...
                <h3 className="text-xl font-bold mb-2">맞춤형 로드맵 설정</h3>
                <p className="text-gray-600">
                  나의 상황과 목표에 맞는 취업 준비 로드맵을 설정하고 단계별로
                  필요한 자원을 확인하세요.
                </p>
              </div>
              <div className="md:w-1/2 md:pl-12 relative">
            ...
            <div className="md:flex items-center flex-row-reverse">
              <div className="md:w-1/2 md:pl-12 mb-6 md:mb-0">
                ...
                <h3 className="text-xl font-bold mb-2">AI 포트폴리오 구성</h3>
                <p className="text-gray-600">
                  나의 이력과 목표를 기반으로 AI가 추천하는 맞춤형 포트폴리오
                  예시를 받아보고, 이를 기반으로 나만의 성장 기록을 구성하세요.
                </p>
              </div>
              <div className="md:w-1/2 md:pr-12 relative">
                <div className="hidden md:block absolute top-0 right-0 w-6 h-6 bg-cyan-500 rounded-full transform translate-x-1/2"></div>
            ...
            <div className="md:flex items-center">
              <div className="md:w-1/2 md:pr-12 mb-6 md:mb-0 md:text-right">
                ...
                <p className="text-gray-600">
                  비슷한 경험을 가진 멘토와 연결되어 실질적인 조언을 받고,
                  커뮤니티에서 정보와 경험을 공유하세요.
                </p>
              </div>
              <div className="md:w-1/2 md:pl-12 relative">
      ...
      <div className="text-center">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
          갭로그와 함께 공백기를 의미있는 시간으로 만들고, 자신감을 회복하여
          새로운 시작을 준비해보세요.
        </p>
