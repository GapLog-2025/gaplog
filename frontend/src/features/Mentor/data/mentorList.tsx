    ...
    replies: [
      {
        ...
        mentorId: 1,
        userName: '현직디자이너',
        content: `비전공자도 충분히 개발자가 될 수 있습니다. 저 역시 비전공자 출신이고, 주변에도 비전공자 출신 개발자들이 많아요.

포트폴리오 관련해서는:
1. 기본기가 탄탄한 프로젝트 2-3개
2. 클린 코드와 주석 작성
3. GitHub 관리 (커밋 메시지, README 등)
4. 배포까지 완료된 프로젝트

학력보다는 실력이 더 중요합니다. 특히 스타트업이나 중소기업에서는 포트폴리오와 코딩테스트 결과를 더 중시해요.

부트캠프 vs 독학은 개인 성향에 따라 다르지만, 체계적인 학습과 네트워킹을 원한다면 부트캠프를, 자기주도 학습이 가능하다면 독학도 좋습니다.
