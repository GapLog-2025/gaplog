        ...
        <CardContent>
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between">
              ...
              <span
                className={`px-2 py-1 rounded-full text-xs font-medium ${
                  portfolioData.personalInfo.name ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-600"
                }`}
              >
            ...
            <div className="flex items-center justify-between">
              ...
              <span
                className={`px-2 py-1 rounded-full text-xs font-medium ${
                  portfolioData.skills.length > 0 ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-600"
                }`}
              >
                {portfolioData.skills.length > 0 ? `${portfolioData.skills.length}개` : "미완료"}
              </span>
            </div>
            <div className="flex items-center justify-between">
              ...
              <span
                className={`px-2 py-1 rounded-full text-xs font-medium ${
                  portfolioData.experience.length > 0 ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-600"
                }`}
              >
                {portfolioData.experience.length > 0 ? `${portfolioData.experience.length}개` : "미완료"}
              </span>
            </div>
            <div className="flex items-center justify-between">
              ...
              <span
                className={`px-2 py-1 rounded-full text-xs font-medium ${
                  portfolioData.projects.length > 0 ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-600"
                }`}
              >
                {portfolioData.projects.length > 0 ? `${portfolioData.projects.length}개` : "미완료"}
              </span>
            </div>
          </div>
        </CardContent>
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">직무와 기술 스택을 바탕으로 매력적인 자기소개를 생성합니다.</p>
              </div>
            </div>
            <div className="flex items-start gap-2">
              <div className="w-2 h-2 bg-purple-600 rounded-full mt-2 flex-shrink-0" />
              <div>
                <h4 className="text-sm font-medium text-gray-900">완성된 포트폴리오:</h4>
                <p className="text-sm text-gray-600">모든 정보를 종합하여 완전한 HTML 포트폴리오를 생성합니다.</p>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-col gap-1">
            <p className="text-sm text-gray-600">• 구체적인 성과와 수치를 포함하세요</p>
            <p className="text-sm text-gray-600">• 최신 기술 스택을 강조하세요</p>
            <p className="text-sm text-gray-600">• 프로젝트 링크를 반드시 포함하세요</p>
            <p className="text-sm text-gray-600">• 간결하고 명확한 문장을 사용하세요</p>
    ...
    <Layout aside={<PortfolioSidebar />}>
      <div className="max-w-4xl mx-auto py-8 px-4">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">AI의 도움을 받아 전문적인 포트폴리오를 쉽고 빠르게 만들어보세요.</p>
        </div>

        {/* 진행 상황 */}
        <Card className="mb-8">
          <CardContent>
            <h2 className="text-xl font-semibold mb-4">포트폴리오 제작 진행 상황</h2>
                ...
                >
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center mb-2 ${
                      index <= activeStep ? "bg-purple-600 text-white" : "bg-gray-200 text-gray-400"
                    }`}
                  >
                    {step.icon}
                  </div>
          ...
          <CardContent>
            ...
            {activeStep === 0 && (
                <div>
                    ...
                    {/* 직무/포지션 */}
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">직무/포지션 *</label>
                        <input
                        type="text"
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
            ...
            {activeStep === 1 && (
              <div>
                ...
                <div className="mb-6">
                  <label className="block text-sm font-medium text-gray-700 mb-2">기술 추가</label>
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      onClick={() => {
                        const input = document.querySelector('input[placeholder*="React"]') as HTMLInputElement
                        if (input) {
                ...
                <div className="mb-6">
                  <label className="block text-sm font-medium text-gray-700 mb-2">선택된 기술 스택</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">추천 기술 스택</label>
                  <div className="flex flex-wrap gap-2">
                    {[
                      "React",
                      "Vue.js",
              ...
              <div>
                ...
                {portfolioData.experience.length === 0 ? (
                  <div className="text-center py-12 text-gray-500">
                    ...
                    <p className="text-lg font-medium mb-2">아직 추가된 경력이 없습니다.</p>
                    <p className="text-sm">경력 추가 버튼을 클릭해서 시작하세요.</p>
                  </div>
                ) : (
                      ...
                      <div key={index} className="p-4 border border-gray-200 rounded-lg">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                setPortfolioData((prev) => ({ ...prev, experience: newExp }))
                              }}
                            />
                          </div>
                          <div>
                          ...
                          <div className="md:col-span-2">
                            <label className="block text-sm font-medium text-gray-700 mb-2">근무 기간</label>
                            <input
                              type="text"
                              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
              ...
              <div>
                ...
                {portfolioData.projects.length === 0 ? (
                  <div className="text-center py-12 text-gray-500">
                    ...
                    <p className="text-lg font-medium mb-2">아직 추가된 프로젝트가 없습니다.</p>
                    <p className="text-sm">프로젝트 추가 버튼을 클릭해서 시작하세요.</p>
                  </div>
                ) : (
                  <div className="space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center">
                    ...
                    <h2 className="text-2xl font-semibold">포트폴리오 미리보기</h2>
                  </div>
                  <div className="flex gap-2">
                    <button
                ...
                {generatedContent ? (
                  <div className="space-y-6">
                    ...
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                      <div className="bg-gray-50 px-4 py-2 border-b border-gray-200 flex items-center justify-between">
                        <span className="text-sm font-medium text-gray-700">포트폴리오 미리보기</span>
                        <button
                    ...
                    <div className="border border-gray-200 rounded-lg">
                      ...
                      >
                        <span className="font-medium text-gray-700">생성된 HTML 코드</span>
                        <ChevronDown
                          size={20}
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      <h3 className="font-medium text-blue-900 mb-2">💡 포트폴리오 사용 방법</h3>
                      <ul className="text-sm text-blue-800 space-y-1">
                        <li>
                          <strong>HTML 다운로드:</strong> 생성된 HTML 파일을 다운로드하여 웹 호스팅 서비스에 업로드
                        </li>
                        <li>
                          <strong>GitHub Pages:</strong> GitHub 저장소에 업로드하여 무료 호스팅 가능
                        </li>
                        <li>
                          <strong>Vercel/Netlify:</strong> 정적 사이트 호스팅 서비스 활용
                        </li>
                        <li>
                          <strong>커스터마이징:</strong> HTML/CSS 코드를 수정하여 개인화 가능
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="text-center py-12 text-gray-500">
                    ...
                    <h3 className="text-xl font-semibold mb-2">AI로 포트폴리오 완성하기</h3>
                    <p className="text-gray-600 mb-6 max-w-md mx-auto">
                      입력한 정보를 바탕으로 AI가 전문적인 포트폴리오를 생성해드립니다. 현대적인 디자인과 반응형
                      레이아웃이 적용된 완성된 HTML 파일을 받을 수 있습니다.
                    </p>
                    ...
                    <button
                      ...
                      onClick={generateFullPortfolio}
                      disabled={isGenerating || !portfolioData.personalInfo.name}
                    >
                    ...
                    {!portfolioData.personalInfo.name && (
                      <p className="text-red-500 text-sm mt-3">기본 정보의 이름을 먼저 입력해주세요.</p>
                    )}
                  </div>
                )}
              </div>
